Rails.application.routes.draw do
  ...
  match Easypay::Engine.config.easypay_payment_path => 'easypay/notifications#notification_from_mb_payment'
  match Easypay::Engine.config.redirect_after_payment_path => 'easypay/payments#complete'
